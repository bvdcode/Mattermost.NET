...
namespace Mattermost.Tests
{
    internal class HelperTests
    {
        ...
        {
            const string expected = "page=0&per_page=10&include_deleted=True&since=1690156800000&before=postId1&after=postId2";
            var actual = QueryHelpers.BuildChannelPostsQuery(0, 10, beforePostId: "postId1", afterPostId: "postId2", includeDeleted: true, since: new DateTime(2023, 7, 24, 0, 0, 0, DateTimeKind.Utc));
